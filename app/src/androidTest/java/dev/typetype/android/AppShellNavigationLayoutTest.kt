...
class AppShellNavigationLayoutTest {
    @get:Rule
    val composeRule = createAndroidComposeRule<ComponentActivity>()

    @Test
    fun wideWindowUsesBottomNavigation() {
        ...
        composeRule.setContent {
            ...
            CompositionLocalProvider(
                ...
                AppShell(
                    ...
                    playerHostController = PlayerHostController(TabletLayoutQueueController()),
                    onOpenSettings = {},
                    onPlayVideo = {},
                    onOpenChannel = {},
                    onOpenAccounts = {},
...
private class TabletLayoutQueueController : PlaybackQueueController {
